...
//             Software feature
//           </span>
//           <Header content="Scale quickly and easily with SK" />
//           <Paragraph content="Empower your growth with seamless efficiency. Elevate your business effortlessly." />
...
//           <img
//             src="https://mir-s3-cdn-cf.behance.net/project_modules/fs/26dfd8180960773.6513b10d073c7.jpg"
//             alt="features"
//             loading="lazy"
...
//             Software feature
//           </span>
//           <Header content="Build Meaningful Connections with SK" />
//           <Paragraph content="Seamlessly connect, collaborate, and grow together." />
...
//               <h1 className="text-2xl font-bold">Stronger Networks</h1>
//               <p className="text-[16px] pt-2 text-zinc-400 w-full">
//               Enhance engagement and expand your reach effortlessly.{" "}
//               </p>
//             </div>
//           </div>
//           <a
//             className="pl-4 md:pl-12 lg:pl-0"
//             href="https://mir-s3-cdn-cf.behance.net/project_modules/fs/26dfd8180960773.6513b10d073c7.jpg"
//           >
...
//   return (
//     <div className="relative flex flex-col py-24 min-h-screen md:h-auto w-full items-center justify-center">
...
//         alt="bgRight"
//         loading="lazy"
//         className="absolute right-0 top-0 z-0 w-auto h-full"
//       />
  ...
  return (
    <div className="relative flex flex-col py-24 min-h-screen md:h-auto w-full items-center justify-center">
      ...
      <motion.div
        ...
        className="w-full z-10 lg:min-h-screen justify-center items-center grid gap-8 lg:grid-cols-2 grid-cols-1 lg:px-10"
      >
        <div className="w-full flex pl-4 md:pl-12 lg:pl-20 lg:justify-start md:mt-0 mt-10">
          <img
            src="https://mir-s3-cdn-cf.behance.net/project_modules/fs/26dfd8180960773.6513b10d073c7.jpg"
            alt="features"
            loading="lazy"
        ...
        <div className="flex z-10 flex-col md:max-w-md lg:max-w-md pl-4 md:pl-12 lg:pr-20 gap-3">
          <span className="text-[#b6ff9c] font-bold text-lg">Software feature</span>
          <Header content="Scale quickly and easily with SK" />
          <Paragraph content="Empower your growth with seamless efficiency. Elevate your business effortlessly." />
          <div className="flex gap-3 items-center mt-4">
