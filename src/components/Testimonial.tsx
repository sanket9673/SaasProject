        ...
        <div className="bg-[#b6ff9c] px-8 pt-8 rounded-xl w-fit text-black flex flex-col">
          <div className=" w-fit max-w-md">
            <h1 className="text-[24px] md:text-[28px] lg:text-[32px] font-bold">
              “Collaborating with SK has been seamless and effortless from day one.”
            </h1>
            <div className="flex items-center my-5 gap-2">
              ...
              <div>
                <h1 className="font-semibold">Saurabh Kadam</h1>
                <p className="text-gray-600">CTO @AI Chef Master</p>
              </div>
            </div>
          </div>
          <div className="flex w-fit justify-start">
            <img
              src="https://themewagon.com/wp-content/uploads/2022/09/burn-up.png"
              alt="block"
              loading="lazy"
            />
          </div>
