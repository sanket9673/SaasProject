    ...
    <div className="flex lg:min-h-screen py-28 items-center justify-center w-full px-4 md:px-12">
      <div className="grid grid-cols-1 relative lg:grid-cols-2 overflow-hidden bg-[#1a1a1a] rounded-3xl h-full w-full">
        ...
        >
          ...
          <Header content="Build powerful SaaS solutions with SK" />
          <Paragraph content="Unlock seamless efficiency and innovation for your business." />
          ...
          >
            <span>Browse your compatible service.</span>
            <img
        ...
        <div className="">
          ...
          /> */}
          <video
            src="https://cdn.dribbble.com/userupload/7490404/file/original-0eece742b37ab81afc04ead04ef38da1.mp4"
            autoPlay
            loop
            muted
            playsInline
            className="z-40 w-full h-full object-cover"
          />
        </div>
      </div>
    </div>
